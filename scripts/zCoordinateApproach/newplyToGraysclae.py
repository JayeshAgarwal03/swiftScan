...
# --- CONFIGURATION ---
INPUT_PLY = "/home/jayesh/segmentation/swiftScan/data/25 Tiles/grid_2_0.ply"
OUTPUT_FOLDER = "/home/jayesh/segmentation/swiftScan/results/zCoordinateApproach/ndsm"
...
def blind_segmentation():
    ...
    output_mask = os.path.join(OUTPUT_FOLDER, "blind_building_mask.png")
    print(f"Saving blind mask to {output_mask}")
    ...
    output_roughness = os.path.join(OUTPUT_FOLDER, "blind_building_mask_roughness_debug.png")
    cv2.imwrite(output_roughness, roughness_img)
